...
$conn = mysqli_connect('localhost', 'root', '', 'csdl_2') or die ('Lỗi kết nối'); mysqli_set_charset($conn, "utf8");
...
echo '<script language="javascript">alert("Đăng ký thành công!"); window.location="trangchu.html";</script>';
